        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16">
          ...
          <div>
            ...
            <form action="https://formspree.io/f/xblzrydv" method="POST" className="space-y-6">
              <div>
                <label htmlFor="name" className="block text-sm font-medium text-gray-700 font-helvetica-regular">Nama Lengkap</label>
                <input 
                  type="text" 
                  name="name" 
                  id="name" 
              ...
              <div>
                <label htmlFor="email" className="block text-sm font-medium text-gray-700 font-helvetica-regular">Alamat Email</label>
                <input 
                  type="email" 
                  name="email" 
                  id="email" 
              ...
              <div>
                <label htmlFor="message" className="block text-sm font-medium text-gray-700 font-helvetica-regular">Pesan Anda</label>
                <textarea 
                  name="message" 
                  id="message" 
                  rows={4} 
              ...
              <div>
                <button 
                  type="submit" 
                  className="w-full bg-gray-800 text-white font-helvetica-regular py-3 px-6 rounded-lg hover:bg-black transition-colors"
                >
                  Kirim Pesan
                </button>
              </div>
