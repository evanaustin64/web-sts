...
{product.variations && product.variations.length > 0 && (
  <div className="mt-6">
    ...
    <div className="flex flex-col sm:flex-row sm:items-start sm:gap-4"> {/* Mengatur layout horizontal untuk desktop, vertikal untuk mobile */}
      ...
      {/* Container untuk setiap variasi (gambar di atas, nama di bawah) */}
      <div className="flex flex-wrap gap-4 mt-3 sm:mt-0"> {/* Hapus mt-3 di sm:mt-0 jika judul dan variasi sejajar */}
