...
export default function MaintenancePage() {
	...
	C295.93,146.74,296.28,145.69,296.6,144.62z"
                    ...
                    <div className="mb-6">
                        <span className="inline-flex items-center gap-2 px-4 py-2 bg-yellow-400/20 backdrop-blur-md rounded-full border border-yellow-400/30 text-yellow-300 text-sm font-semibold">
                            ...
                            <span className='font-helvetica-regular'>UNDER MAINTENANCE</span>
  ...
  <path d="M0 2a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2zm8.93 4.588-2.29.287-.082.38.45.083c.294.07.352.176.288.469l-.738 3.468c-.194.897.105 1.319.808 1.319.545 0 1.178-.252 1.465-.598l.088-.416c-.2.176-.492.246-.686.246-.275 0-.375-.193-.304-.533zM8 5.5a1 1 0 1 0 0-2 1 1 0 0 0 0 2"/>
                            ...
                            <h3 className="text-white font-helvetica-regular text-lg mb-2">Pembaruan Informasi</h3>
                            <p className="text-blue-200/70 text-sm font-helvetica-light">Mohon Ditunggu...</p>
                        </div>
                    </div>

                    {/* Contact Info */}
                    <div className="bg-white/5 backdrop-blur-lg rounded-2xl p-6 sm:p-8 border border-white/10 max-w-2xl mx-auto mb-8">
                        <h2 className="text-white font-helvetica-black text-xl mb-4">Butuh Bantuan Segera?</h2>
                        <p className="text-blue-200/70 mb-6 font-helvetica-regular">Hubungi kami melalui kontak di bawah ini</p>
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center">
                            ...
                            >
                                ...
                                <span className='font-helvetica-regular'>WhatsApp</span>
                            ...
                            >
                                ...
                                <span className='font-helvetica-regular'>Email kami</span>
                            </a>
                        </div>
                    </div>

                    {/* Footer */}
                    <div className="text-blue-200/60 text-sm font-helvetica-light">
                        <p>&copy; 2025 PT Samudra Teknik Sejahtera. All rights reserved.</p>
                        <p className="mt-2 font-helvetica-light">Terima kasih atas kesabaran Anda 🙏</p>
                    </div>
                </div>
            </div>
